...
import "../Internship/AddNewCard.css";
import Placement from "../../../Pages/Placements/Placement";
import axios from "axios";
const AddPlacementNewCard = () => {
  ...
  async function addChanges(e) {
    e.preventDefault();
    try {
      await axios.post(`http://localhost:4040/profiles/placement/new`, profile);
...
export default AddPlacementNewCard;
